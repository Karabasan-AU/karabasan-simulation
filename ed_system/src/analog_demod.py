...
class AnalogDemodulator:
    ...
    def process_block(self, iq_data):
        """
        Gelen ham I/Q bloklarını (NumPy array) işler ve temiz ses dalgasını döndürür.
        """
        # --- ADIM 1: Quadrature Demodulation (FM Demod) [cite: 64] ---
        ...
        # --- ADIM 3: Decimation (Seyreltme) [cite: 66] ---
        ...
        # --- ADIM 4: AGC (Otomatik Kazanç Kontrolü) [cite: 66] ---
